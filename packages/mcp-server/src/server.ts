...
import { ClientOptions } from 'morta';
...
export { ClientOptions } from 'morta';
...
export function initMcpServer(params: {
  ...
  const client = new Morta(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client =
    params.client || new Morta({ defaultHeaders: { 'X-Stainless-MCP': 'true' }, logger: logger });
