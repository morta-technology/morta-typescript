...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['attributeKind', 'resourceId', 'resourceKind', 'role'],
    $defs: {
...
export const handler = async (client: Morta, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.permissions.createAll(body)));
};
