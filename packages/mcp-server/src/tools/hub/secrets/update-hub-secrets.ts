...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['hub_id', 'secret_id', 'name', 'value'],
  },
  annotations: {
    idempotentHint: true,
  },
...
export const handler = async (client: Morta, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.hub.secrets.update(secret_id, body)));
};
