...
export const tool: Tool = {
  ...
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nSync a table with a specified integration.\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/sync_sync_with_integration_response',\n  $defs: {\n    sync_sync_with_integration_response: {\n      type: 'object',\n      properties: {\n        data: {\n          type: 'string'\n        },\n        metadata: {\n          type: 'object',\n          additionalProperties: true\n        }\n      }\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      table_id: {
...
export const handler = async (client: Morta, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.table.sync.syncWithIntegration(integration_name, body)),
    );
  } catch (error) {
