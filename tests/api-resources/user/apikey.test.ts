...
describe('resource apikey', () => {
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.user.apikey.create({
      accessLevel: 0,
      documentRestrictions: ['182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e'],
      name: 'name',
      projectRestrictions: ['182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e'],
      tableRestrictions: ['182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e'],
    });
  });
